...
/**
 * CLI: run task-selection regression dataset.
 *
...
foreach ($cases as $case) {
    ...
    $selected = trim((string)($simulation['selected_task'] ?? ''));
