...
$runs = $DB->get_records_select('local_wizard_benchmark_runs', $where, $params, 'timecreated DESC', '*', 0, $n);
if (empty($runs)) {
...
$rows = $DB->get_records_select('local_wizard_benchmark_scenarios', "run_id {$insql}", $inparams);
