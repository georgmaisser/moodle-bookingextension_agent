...
use context_course;
use bookingextension_agent\local\wbagent\course\skills\diagnose_access_skill;
 ...
 * @covers     \bookingextension_agent\local\wbagent\course\skills\diagnose_access_skill
