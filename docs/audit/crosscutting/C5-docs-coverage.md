...
### [C5-F02] 🟠 HIGH · D6 Docs coverage · docs/architecture/04-…md §9 + 05-…md §2/§8/§9 + docs/reference/flowchart-guide.md (Planner section)
...
### [C5-F03] 🟡 MEDIUM · D6 Docs coverage · docs/architecture/06-…md §3 (+ README §1, ch.05 §1, ch.16)
...
### [C5-F04] 🟡 MEDIUM · D6 Docs coverage · docs/reference/flowchart-guide.md (Planner section, lines ~112–121)
