...
### [C3-F02] 🟡 MEDIUM · D4 Duplication · `services/preflight_error_classifier.php` + `services/retry_policy_service.php` (corroborates 08-F01)
**What:** Two independent substring-matching classifiers over the same issue-code vocabulary live side by side and can silently drift — confirmed against code, matching section 08-F01.
