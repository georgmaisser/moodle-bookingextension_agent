...
- [classes/local/wbagent/task_registry.php](../../classes/local/wbagent/task_registry.php)
- [classes/local/wbagent/task_executability_evaluator.php](../../classes/local/wbagent/task_executability_evaluator.php)
...
- [classes/local/wbagent/core/tasks/recreate_task_catalog_task.php](../../classes/local/wbagent/core/tasks/recreate_task_catalog_task.php)
- [classes/task/rebuild_task_catalog_embeddings_adhoc.php](../../classes/task/rebuild_task_catalog_embeddings_adhoc.php)
...
- `task_registry::get_task_contract()`
- `task_registry::get_task_contracts()`
- `task_registry::get_all_prompt_contracts()`
- `task_registry::get_prompt_contracts_for_context()`
- `task_registry::get_all_schemas_for_context()`
- `task_registry::is_task_active()`
- `task_registry::get_task_capabilities()`
- `task_registry::get_task_names_for_context()`
- `task_executability_evaluator::evaluate_task()`
- `task_executability_evaluator::evaluate_all_tasks()`
- `task_executability_evaluator::get_executable_task_names()`
...
- Assistant-Metadaten fuer `attempted_tasks` und `commands`.
...
Der Task `core.recreate_task_catalog` ist selbst ein gutes Beispiel fuer den Sicherheitsansatz des Systems.

Wesentliche Methoden:

- `recreate_task_catalog_task::get_name()`
- `recreate_task_catalog_task::get_schema()`
- `recreate_task_catalog_task::get_message_triggers()`
- `recreate_task_catalog_task::check_structure()`
- `recreate_task_catalog_task::execute()`
- `rebuild_task_catalog_embeddings_adhoc::execute()`
...
flowchart TD
    ...
    D -->|yes| F[search_top_k() on task_catalog_embeddings.csv]
    F --> G[build_planner_catalog_subset()]
    G --> H[filter by task_executability_evaluator]
