...
- classes/local/wbagent/services/debug/task_selection_debug_service.php
- classes/local/wbagent/services/debug/task_similarity_analyzer.php
- classes/local/wbagent/services/debug/task_selection_dataset_runner.php
...
- cli/task_selection_debug.php
  - --input="..."
  - --contextid=...
  - --topk=...
  - --json
- cli/task_selection_dataset.php
...
- Anzahl Fälle mit leerem selected_task
...
- Debug-Seite ist nur mit bookingextension/agent:debugtaskselection sichtbar.
