...
class provider implements
    ...
    private const THREADS_TABLE = 'local_wbagent_ai_threads';

    /** Conversation message table. */
    private const MESSAGES_TABLE = 'local_wbagent_ai_messages';

    /** Execution run table. */
    private const RUNS_TABLE = 'local_wbagent_ai_runs';

    /** Raw LLM debug log table. */
    private const DEBUG_TABLE = 'local_wbagent_ai_llm_debug';
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_database_table(
            self::THREADS_TABLE,
            [
                'userid' => 'privacy:metadata:local_wbagent_ai_threads:userid',
                'contextid' => 'privacy:metadata:local_wbagent_ai_threads:contextid',
                'status' => 'privacy:metadata:local_wbagent_ai_threads:status',
                'metadatajson' => 'privacy:metadata:local_wbagent_ai_threads:metadatajson',
                'timecreated' => 'privacy:metadata:local_wbagent_ai_threads:timecreated',
                'timemodified' => 'privacy:metadata:local_wbagent_ai_threads:timemodified',
            ],
            'privacy:metadata:local_wbagent_ai_threads'
        );

        $collection->add_database_table(
            self::MESSAGES_TABLE,
            [
                'userid' => 'privacy:metadata:local_wbagent_ai_messages:userid',
                'role' => 'privacy:metadata:local_wbagent_ai_messages:role',
                'content' => 'privacy:metadata:local_wbagent_ai_messages:content',
                'structuredjson' => 'privacy:metadata:local_wbagent_ai_messages:structuredjson',
                'timecreated' => 'privacy:metadata:local_wbagent_ai_messages:timecreated',
            ],
            'privacy:metadata:local_wbagent_ai_messages'
        );

        $collection->add_database_table(
            self::RUNS_TABLE,
            [
                'userid' => 'privacy:metadata:local_wbagent_ai_runs:userid',
                'contextid' => 'privacy:metadata:local_wbagent_ai_runs:contextid',
                'status' => 'privacy:metadata:local_wbagent_ai_runs:status',
                'commandsjson' => 'privacy:metadata:local_wbagent_ai_runs:commandsjson',
                'resultsjson' => 'privacy:metadata:local_wbagent_ai_runs:resultsjson',
                'timecreated' => 'privacy:metadata:local_wbagent_ai_runs:timecreated',
                'timemodified' => 'privacy:metadata:local_wbagent_ai_runs:timemodified',
            ],
            'privacy:metadata:local_wbagent_ai_runs'
        );

        $collection->add_database_table(
            self::DEBUG_TABLE,
            [
                'userid' => 'privacy:metadata:local_wbagent_ai_llm_debug:userid',
                'contextid' => 'privacy:metadata:local_wbagent_ai_llm_debug:contextid',
                'source' => 'privacy:metadata:local_wbagent_ai_llm_debug:source',
                'requesttext' => 'privacy:metadata:local_wbagent_ai_llm_debug:requesttext',
                'responsetext' => 'privacy:metadata:local_wbagent_ai_llm_debug:responsetext',
                'success' => 'privacy:metadata:local_wbagent_ai_llm_debug:success',
                'errormessage' => 'privacy:metadata:local_wbagent_ai_llm_debug:errormessage',
                'timecreated' => 'privacy:metadata:local_wbagent_ai_llm_debug:timecreated',
            ],
            'privacy:metadata:local_wbagent_ai_llm_debug'
        );
    ...
    private static function export_conversations(context $context, int $userid): void {
        ...
        writer::with_context($context)->export_data(
            [get_string('privacy:metadata:local_wbagent_ai_threads', 'bookingextension_agent')],
