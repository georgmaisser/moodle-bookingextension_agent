        ...
        return [
            [
                ...
                'guidance' => [
                    ...
                    '- Identify the person via userquery/userid (default: the asking user). For access/progress name a',
                    '  specific activity via activityquery; if the returned list shows several, re-call with activityid.',
