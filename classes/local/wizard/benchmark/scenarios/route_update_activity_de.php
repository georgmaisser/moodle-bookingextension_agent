...
/**
 * Routing scenario: Rename an EXISTING activity -> update_activity (not create)
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class route_update_activity_de extends abstract_routing_scenario {
    /**
    ...
    public function get_key(): string {
        return 'route_update_activity_de';
    }
    ...
    public function get_description(): string {
        return 'Rename an EXISTING activity -> update_activity (not create)';
    }
    ...
    public function get_user_message(): string {
        return 'Benenne die Seite "Willkommen" in "Kurseinfuehrung" um.';
    }
