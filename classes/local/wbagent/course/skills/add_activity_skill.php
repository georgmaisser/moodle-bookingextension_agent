...
use bookingextension_agent\local\wbagent\services\activities\activity_creation_service;
use bookingextension_agent\local\wbagent\services\activities\activity_preview_renderer;
use bookingextension_agent\local\wbagent\services\activities\module_catalog_service;
use bookingextension_agent\local\wbagent\services\activities\module_form_contract;
...
class add_activity_skill extends core_skill_base implements skill_trigger_provider_interface {
    ...
    /**
     * This skill can create the activity in a course other than the current one (cross-context).
     *
     * @return bool
     */
    ...
    /**
     * Build the target-course selector from courseid / coursequery (null → current course).
     *
     * @param array $input
