...
use bookingextension_agent\local\wbagent\benchmark\scenarios\create_option_basic;
use bookingextension_agent\local\wbagent\benchmark\scenarios\create_option_multistep;
use bookingextension_agent\local\wbagent\benchmark\scenarios\update_option_trainer;
use bookingextension_agent\local\wbagent\benchmark\scenarios\book_users_single;
use bookingextension_agent\local\wbagent\benchmark\scenarios\short_confirm_ja;
use bookingextension_agent\local\wbagent\benchmark\scenarios\short_confirm_weiter;
use bookingextension_agent\local\wbagent\benchmark\scenarios\clarification_missing_date;
...
use bookingextension_agent\local\wbagent\benchmark\scenarios\get_current_user_readonly;
