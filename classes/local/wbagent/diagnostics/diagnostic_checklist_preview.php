...
namespace bookingextension_agent\local\wbagent\diagnostics;
    ...
    private function build_html(array $rows, string $title): string {
        ...
        foreach ($rows as $row) {
            ...
            $items .= \html_writer::tag(
                ...
                ['class' => 'wbagent-diagnostic-row mb-1']
            );
        }
        ...
        return \html_writer::tag('div', $heading . $list, ['class' => 'wbagent-diagnostic-checklist card card-body']);
    }
}
